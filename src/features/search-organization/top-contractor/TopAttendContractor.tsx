...
interface ITopAttendContractorProps {
  //   data: any
}

export const TopAttendContractor = (props: ITopAttendContractorProps) => {
  ...
  const columns: ColumnsType<StatisticOrganization> = [
    ...
    },
    {
      ...
      dataIndex: 'attendedBidPackages',
      align: 'right',
    },
  ]
  return (
    <>
      <p className="font-semibold text-2xl text-center">Top nhà thầu tham dự thầu nhiều nhất</p>
      <Table
        columns={columns}
