...
interface ITopViewContractorProps {
  //   data: any
}

export const TopViewContractor = (props: ITopViewContractorProps) => {
  ...
  const columns: ColumnsType<StatisticOrganization> = [
    ...
    },
    {
      ...
      dataIndex: 'watchedStatuses',
      align: 'right',
    },
  ]
  return (
    <>
      <p className="font-semibold text-2xl text-center">Top nhà thầu bị "soi" nhiều nhất</p>
      <Table
        columns={columns}
